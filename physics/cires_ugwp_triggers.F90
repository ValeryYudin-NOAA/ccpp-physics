...
!================================================================
      ...
      real    :: tau_amp, xlatdeg(im), tau_gw(im)
      real    :: latdeg, flat_gw, tem
      real, parameter    :: fampqbo = 1.25    ! 1.5     
      real, parameter    :: famp60S = 1.0     ! 1.5
      real, parameter    :: famp60N = 1.0     ! 1.0
      real, parameter    :: famp30  = 0.25    ! 0.4
        
      real, parameter    :: swid15  = 12.5  
      real, parameter    :: swid60S  = 30.0   ! 40
      real, parameter    :: swid60N  = 25.0   ! 30                 
      integer :: i
!    
!
!
...
!=================
      ...
      real  :: tau_gw(im)
      real  :: latdeg
      real, parameter  :: tau_amp = 3.5e-3    ! 3.5 mPa 
...
!      real, dimension(im, levs+1)  :: pint    
      ...
      integer ::  nf_src
! locals
      real, parameter           ::  tlim_okw = 100.                  ! trig_fgf > tlim_fgf, launch GWs should scale-dependent
